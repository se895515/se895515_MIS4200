...
using se895515_MIS4200.DAL__Data_Access_Layer_;
...
namespace se895515_MIS4200.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseDetailID,numberOfStudents,courseProfessor,studentID,courseID")] CourseDetail courseDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseDetailID,numberOfStudents,courseProfessor,studentID,courseID")] CourseDetail courseDetail)
        {
            if (ModelState.IsValid)
            {
